    ...
    <>
      <section className=" overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        ...
        <TitleSection
          ...
          subheading="A platform that helps you and your team to stay organized, communicate effectively and work smarter."
        />
        <div
          className="bg-white
          p-[2px]
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        <TitleSection
          ...
          subheading="FocusMemo is a platform that helps you and your team to stay organized, communicate effectively and work smarter."
          pill="Features"
        />
        <div
          className="mt-10
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          subheading="Join thousands of satisfied users who rely on our platform for their pernal and professional productivity needs."
          pill="Testimonials"
        />
        <div className="flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
          {PRICING_CARDS.map((card) => (
            <CustomCard
              key={card.planType}
              className={clsx(
                "w-[300px] rounded-2xl dark:bg-black/40 background-blue-3xl",
                {
